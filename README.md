...
Continuing from the data scraped for the training set, the test set extends from now (April 2021) until the end of the available data (2029), which was likewise challenging as the format inconsistency continued onto rows in addition to the already missing column data. 
